...
class ClientPhotolab(object):
    ...
    api_upload_endpoint: str = 'http://upload-soft.photolab.me/upload.php?no_resize=1'
    ...
    def image_upload(self, image):
        ...
        :param image: img
        :return: url http://temp-images.ws.pho.to/*****/.jpeg
        '''
        image_blob = None
        ...
        print('resp_body-->', resp_body)  # resp_body
